@extends('layouts.app')
@section('title','Maisonneuve - ' .trans('lang.text_heading_new_document'))
@section('heading-title', trans('lang.text_heading_new_document'))
            ...
            <form method="POST" enctype="multipart/form-data">
                ...
                <div class="row">
                    ...
                    <div class="border border-top-0 pb-3">
                        ...
                        <input type="file" class="form-control @if ($errors->has('fichier')) border-danger @endif" id="fichier" name="fichier" title="your text">
                    </div>
                </div>
                @if(count($errors) > 0)
